...
public class ClassVO {
	...
	public ClassVO(int no, String mNum, String mName, String iName, int grade) {
		super();
		this.no = no;
		this.mNum = mNum;
		this.mName = mName;
	...
	public ClassVO(int no, String iName, int grade) {
		super();
		this.no = no;
		this.iName = iName;
		this.grade = grade;
	...
	public ClassVO(String mNum, String mName, String iName, int grade) {
		super();
		this.mNum = mNum;
		this.mName = mName;
		this.iName = iName;
	...
	public ClassVO(String mNum, String iName, int grade) {
		super();
		this.mNum = mNum;
		this.iName = iName;
		this.grade = grade;
