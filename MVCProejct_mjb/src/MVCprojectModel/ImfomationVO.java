...
public class ImfomationVO {
	...
	public ImfomationVO(int no, String mNum, String mName, String iName, int grade) {
		super();
		this.no = no;
		this.mNum = mNum;
		this.mName = mName;
	...
	public ImfomationVO(int no, String iName, int grade) {
		super();
		this.no = no;
		this.iName = iName;
		this.grade = grade;
	...
	public ImfomationVO(String mNum, String mName, String iName, int grade) {
		super();
		this.mNum = mNum;
		this.mName = mName;
		this.iName = iName;
	...
	public ImfomationVO(String mNum, String iName, int grade) {
		super();
		this.mNum = mNum;
		this.iName = iName;
		this.grade = grade;
