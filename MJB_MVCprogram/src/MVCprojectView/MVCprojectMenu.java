...
public class MVCprojectMenu {
	...
	public static void majorClassMenuView() {
		...
		System.out.print(String.format("%-10s", "01"));
		System.out.print(String.format("%-9s", "2. 유아교육과"));
		System.out.print(String.format("%-10s", "02"));
		System.out.print(String.format("%-8s", "3. 건축학과"));
		System.out.println(String.format("%-4s", "03"));
		System.out.println();
		System.out.print(String.format("%-5s", ""));
		System.out.print(String.format("%-21s", "4. 모두보기"));
		System.out.print(String.format("%-19s", "5. 과목 입력"));
		System.out.println(String.format("%-1s", "6. 과목 삭제"));
		System.out.println();
		System.out.print(String.format("%-5s", ""));
		System.out.println(String.format("%-10s", "7. 뒤로가기"));
		System.out.println();
		System.out.println("=============================================================================");
		System.out.println();
		System.out.print("번호를 선택 해 주세요 : ");
